...
interface UIState {
  appointmentModal: { open: boolean; editId: string | null };
...
const initialState: UIState = {
  appointmentModal: { open: false, editId: null },
...
const uiSlice = createSlice({
  ...
  initialState,
  reducers: {
    openAppointmentModal(state, action: PayloadAction<string | null>) {
      state.appointmentModal = { open: true, editId: action.payload };
    },
    closeAppointmentModal(state) {
      state.appointmentModal = { open: false, editId: null };
    },
